...
Mobile phone technology details is a very complex topic which is on the industria hands, but far away from the citizens who only have the possibility of becaming a plain/passive user. For most of us a phone modem is just a black box where we don't know what is going on.

I am not an expert on this topic but one day I decided to learn a bit of it. So I started reading about GSM technology, but I found the information very hard to find and understand for a non expert guy.
